...
function CategoryCard({ type, index }: { type: ComponentType; index: number }) {
  ...
  return (
    <Link
      ...
      className="relative glass-panel glow-hover p-6 rounded-xl flex flex-col items-center justify-center gap-4 text-center group transition-all hover:-translate-y-1 overflow-hidden animate-fade-in-up"
    >
